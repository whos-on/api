...
router.put("/addFriend", addFriendController);
...
router.put("/processRequest", async (request, response) => {
  ...
  if (!newFriendObj) {
    return response
      .status(404)
      .send({ error: "This user doesn't exist anymore!" });
  }
